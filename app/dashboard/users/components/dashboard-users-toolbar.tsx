...
type DashboardUsersToolbarProps = {
...
export function DashboardUsersToolbar({
  copy,
  onBulkDelete,
  onPageSizeChange,
  onSearchQueryChange,
    ...
    <>
      <div className="left-block flex w-full flex-wrap items-center gap-2 xl:max-w-xl xl:flex-nowrap">
        ...
        <Button
          ...
          hidden={selectedUserCount === 0}
          onClick={onBulkDelete}
        >
          <Trash2Icon data-icon="inline-start" />
          {copy.bulkDelete}
          {selectedUserCount > 0 ? ` (${selectedUserCount})` : null}
        </Button>
      </div>
